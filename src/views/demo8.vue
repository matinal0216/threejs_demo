...
const render = async () => {
  ...
  // gltf模型
  const gltfLoader = new GLTFLoader().setPath("./model/demo6/toukui/glft/");
  gltfLoader.load("DamagedHelmet.gltf", (glb) => {
    console.log("glb", glb);
    let model = glb.scene;
  ...
  rgbeLoader.loadAsync("./model/demo6/toukui/textures/royal_esplanade_1k.hdr").then((texture) => {
